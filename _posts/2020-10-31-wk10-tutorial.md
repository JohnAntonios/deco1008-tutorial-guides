...
Also, make sure to delete any objects as a result of a Non-Destructive Boolean (COMBINED_DIF) and no **Mask** object. For example, these two underlined should be deleted.
