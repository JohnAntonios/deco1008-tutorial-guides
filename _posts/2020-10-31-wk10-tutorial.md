...
<details markdown="1">
  ...
  <summary style="color: #E64626;">My paint looks fuzzy / painting areas that I did not want!</summary>

This is due to overlapping UV faces. There are two workarounds, the first is more accurate, but the second is quicker.
